...
private:
	...
	typedef void (rs274ngc::*read_function_pointer) (char *, int *, block_t&, double *);
	...
	void arc_data_comp_r(int move, int side, double tool_radius, double current_x, double current_y, double end_x, double end_y, double big_radius, double * center_x, double * center_y, int * turn);
	...
	void parse_line(char * line, block_t& block,setup_t& settings);
	int precedence(int an_operator);
	void read_a(char * line, int * counter, block_t& block, double * parameters);
	void read_atan(char * line, int * counter, double * double_ptr, double * parameters);
	void read_b(char * line, int * counter, block_t& block, double * parameters);
	void read_c(char * line, int * counter, block_t& block, double * parameters);
	void read_comment(char * line, int * counter, block_t& block, double * parameters);
	void read_d(char * line, int * counter, block_t& block, double * parameters);
	void read_f(char * line, int * counter, block_t& block, double * parameters);
	void read_g(char * line, int * counter, block_t& block, double * parameters);
	void read_h(char * line, int * counter, block_t& block, double * parameters);
	void read_i(char * line, int * counter, block_t& block, double * parameters);
	void read_integer_unsigned(char * line, int * counter, int * integer_ptr);
	void read_integer_value(char * line, int * counter, int * integer_ptr, double * parameters);
	void read_items(block_t& block, char * line, double * parameters);
	void read_j(char * line, int * counter, block_t& block, double * parameters);
	void read_k(char * line, int * counter, block_t& block, double * parameters);
	void read_l(char * line, int * counter, block_t& block, double * parameters);
	void read_line_number(char * line, int * counter, block_t& block);
	void read_m(char * line, int * counter, block_t& block, double * parameters);
	void read_one_item(char * line, int * counter, block_t& block, double * parameters);
	void read_operation(char * line, int * counter, int * operation);
	void read_operation_unary(char * line, int * counter, int * operation);
	void read_p(char * line, int * counter, block_t& block, double * parameters);
	void read_parameter(char * line, int * counter, double * double_ptr, double * parameters);
	void read_parameter_setting(char * line, int * counter, block_t& block, double * parameters);
	void read_q(char * line, int * counter, block_t& block, double * parameters);
	void read_r(char * line, int * counter, block_t& block, double * parameters);
	void read_real_expression(char * line, int * counter, double * hold2, double * parameters);
	void read_real_number(char * line, int * counter, double * double_ptr);
	void read_real_value(char * line, int * counter, double * double_ptr, double * parameters);
	void read_s(char * line, int * counter, block_t& block, double * parameters);
	void read_t(char * line, int * counter, block_t& block, double * parameters);
	int read_text(const char * command, char * raw_line, char * line, int * length);
	void read_unary(char * line, int * counter, double * double_ptr, double * parameters);
	void read_x(char * line, int * counter, block_t& block, double * parameters);
	void read_y(char * line, int * counter, block_t& block, double * parameters);
	void read_z(char * line, int * counter, block_t& block, double * parameters);
